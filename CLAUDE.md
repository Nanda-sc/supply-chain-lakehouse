...
Pipeline covers bronze → silver → gold + dashboard + 38 tests.
...
**Gold** (`src/gold/`)
- Three independent scripts, run in parallel in the Airflow DAG
...
- Functions for full tables and pre-aggregated summaries

**Dashboard** (`dashboard/app.py`)
- Streamlit + Plotly, runs at `http://localhost:8501`
- Four sections: Overview KPIs, Delivery Performance, Supplier Performance, Shipping Analysis
...
Current coverage: 38 tests (6 bronze, 17 silver, 15 gold).
